...
const Servicios = () => {
  return (
    <div className="servicios-page">
      ...
      {/* Sección de encabezado con un fondo específico para la página de servicios. */}
      ...
      <div className="content-container">
        ...
        {/* Texto introductorio que explica la misión y servicios de la asociación. */}
        ...
        <div className="card-container">
          {/* Tarjeta para el servicio de evaluación inicial. */}
          <Link to="/servicios/ev-inicial" className="zoom-container">
            {/* Fondo de la tarjeta con una imagen específica. */}
          ...
          {/* Tarjeta para el servicio de concienciación del problema. */}
          ...
          {/* Tarjeta para el servicio de desintoxicación segura. */}
          ...
          {/* Tarjeta para el servicio de residencia puntual. */}
